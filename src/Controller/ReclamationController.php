...
{ 
    ...
    #[Route('/mes-reclamations/{iduser}', name: 'mes_reclamations')]
        public function mesReclamations(string $iduser, UserRepository $userRepository): Response
    {
...
public function answer(Request $request, Reclamation $reclamation, EntityManagerInterface $entityManager,\Swift_Mailer $mailer): Response
{
    ...
    if ($form->isSubmitted() && $form->isValid()) {
       ...
       $mailer->send($message);
    //   $userPhoneNumber = '+21626204500'; // Remplacez par le numéro de téléphone de l'utilisateur
